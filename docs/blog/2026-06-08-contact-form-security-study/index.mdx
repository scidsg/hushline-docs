...
[JSON data](pathname:///data/contact-form-study-2026.json), an
[assessed-implementations CSV](pathname:///data/contact-form-study-2026-assessed-implementations.csv),
and the
[fixed top-500 ranking snapshot CSV](pathname:///data/contact-form-study-2026-tranco-XLPJN-top500.csv).
The
